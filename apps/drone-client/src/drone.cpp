...
namespace
{
    ...
    public:
        ...
        void connect()
        {
            ...
            options.set_keep_alive_interval(std::chrono::seconds(20));
            ...
            if (brokerUrl_.rfind("ssl://", 0) == 0)
            {
                ...
                sslOptions.set_enable_server_cert_auth(true);
        ...
        void delivery_complete(
            mqtt::delivery_token_ptr) override
        {
        }
